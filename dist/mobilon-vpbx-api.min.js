...
var MobilonVPBXApi=function(n){var o=n,e=null,i=function(n){var e="//connect.mobilon.ru/api/call/CallToSubscriber";return fetch(e+"?key="+o+"&outboundNumber="+n)},r=function(n){var e="wss://webapi.mobilon.ru:8080/",i=new WebSocket(e);i.onmessage=function(o){n(o)},i.onopen=function(){i.send('{"key":"'+o+'"}')}},t=function(n){e=n},c=function(n){if(e){var o="//connect.mobilon.ru/api/call/info";return fetch(o+"?token="+e+"&callid="+n)}return Promise.reject("token not defined")};return{call:i,subscribe:r,setToken:t,info:c}};