...
var MobilonVPBXApi=function(n){var e=n,o=null,t=function(n){var o="https://connect.mobilon.ru/api/call/CallToSubscriber";return fetch(o+"?key="+e+"&outboundNumber="+n)},r=function(n){var o="wss://webapi.mobilon.ru:8080/",t=new WebSocket(o);return t.onmessage=function(e){n(e)},t.onopen=function(){t.send('{"key":"'+e+'"}')},t},i=function(n){o=n},c=function(n){if(o){var e="https://connect.mobilon.ru/api/call/info";return fetch(e+"?token="+o+"&callid="+n)}return Promise.reject("token not defined")},u=function(n){if(o){var e="https://connect.mobilon.ru/api/call/journal";return fetch(e+"?token="+o+"&date="+n)}return Promise.reject("token not defined")};return{call:t,subscribe:r,setToken:i,info:c,journal:u}};