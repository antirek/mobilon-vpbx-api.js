...
var MobilonVPBXApi=function(n){var e=n,o=null,r=function(n){var o="//connect.mobilon.ru/api/call/CallToSubscriber";return fetch(o+"?key="+e+"&outboundNumber="+n)},t=function(n){var o="wss://webapi.mobilon.ru:8080/",r=new WebSocket(o);return r.onmessage=function(e){n(e)},r.onopen=function(){r.send('{"key":"'+e+'"}')},r},i=function(n){o=n},c=function(n){if(o){var e="//connect.mobilon.ru/api/call/info";return fetch(e+"?token="+o+"&callid="+n)}return Promise.reject("token not defined")},u=function(n){if(o){var e="//connect.mobilon.ru/api/call/journal";return fetch(e+"?token="+o+"&date="+n)}return Promise.reject("token not defined")};return{call:r,subscribe:t,setToken:i,info:c,journal:u}};